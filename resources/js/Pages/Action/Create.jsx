...
export default function Create({auth, sousaxes, responsables}) {
                ...
                <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div className="p-6 text-gray-900 dark:text-gray-100">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            ...
                            <div>
                                <label className="block font-medium text-sm text-gray-700">Montant du budget (EUR)</label>
                                <TextInput
                                    type="number"
                                    name="montant_budget"
                                    value={data.montant_budget}
                                    onChange={(e) => setData('montant_budget', e.target.value)}
                                    className="mt-1 block w-1/2 rounded-md border-gray-300 shadow-sm"
                                />
                                <InputError message={errors.montant_budget} className="mt-2" />
                            </div>
